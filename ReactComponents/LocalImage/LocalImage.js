...
//       require('createReactIOSNativeComponnentClass');
...
//   render: function(){
//     return (
//       <RCTLocalImage ref={SWITCH} style={this.props.style} onChange={this._onChange} on={this.props.value} enabled={!this.props.disabled} />
//     )
//   }
//
// })
